      ...
      <section className="container grid min-h-[50svh] items-center gap-6 sm:gap-8 md:gap-10 py-8 sm:py-12 md:py-20 pt-20 sm:pt-24 md:pt-28">
        <div>
          ...
          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Link href="/contact" className="rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2 sm:px-5 sm:py-2.5 font-semibold text-black shadow-[0_0_24px_rgba(20,244,212,0.35)] transition-all hover:scale-105 text-center text-sm sm:text-base">
              Book a consult
            </Link>
            <Link href="/gallery" className="rounded-xl border border-border/60 px-4 py-2 sm:px-5 sm:py-2.5 hover:bg-secondary/60 transition-colors text-center text-sm sm:text-base">
              See the work
            </Link>
          </div>
        </div>
