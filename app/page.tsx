      ...
      <section ref={hero.ref} className="container grid min-h-[92svh] items-center gap-6 py-8 sm:gap-8 sm:py-12 md:grid-cols-2 md:gap-10 md:py-20 pt-16 sm:pt-20">
        <div className={`${hero.inView ? "animate-fade-in-up" : "opacity-0"}`}>
          ...
          <div className="mt-6 sm:mt-8 md:mt-10 flex flex-col sm:flex-row flex-wrap items-center gap-3 sm:gap-4">
            <Link
              href="/contact"
              className="w-full sm:w-auto rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-base font-semibold text-black shadow-[0_0_28px_rgba(20,244,212,0.35)] transition-all hover:scale-105 hover:shadow-[0_0_48px_rgba(124,58,237,0.55)] text-center"
            >
              Book Your Session
            </Link>
            <a
              href="#about"
              className="w-full sm:w-auto rounded-xl border border-border/60 bg-secondary/50 px-4 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-base font-semibold text-foreground/90 transition-all hover:bg-secondary/70 hover:text-foreground text-center"
            >
              Learn More
            </a>
          </div>
        </div>
        <div className="relative h-[30vh] sm:h-[40vh] w-full  rounded-xl md:h-[70vh] order-first md:order-last">
          <Image
  src="/tatoo-0.webp" 
        ...
        <div className="grid gap-6 sm:gap-8 md:gap-10 md:grid-cols-2 md:items-center">
          <div className={`${about.inView ? "animate-fade-in-up" : "opacity-0"}`}>
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href="/about" className="rounded-xl border border-border/60 px-4 py-2 sm:px-5 sm:py-2.5 hover:bg-secondary/60 transition-colors text-center text-sm sm:text-base">Meet the artists</Link>
              <a href="#services" className="rounded-xl px-4 py-2 sm:px-5 sm:py-2.5 bg-accent text-accent-foreground font-semibold transition-all hover:scale-105 hover:shadow-[0_0_28px_rgba(124,58,237,0.45)] text-center text-sm sm:text-base">Explore services</a>
            </div>
          </div>
...
>
        ...
        <div className="container relative z-10 py-16 sm:py-20 md:py-24 lg:py-32">
          <div className={`max-w-3xl ${services.inView ? "animate-fade-in-up" : "opacity-0"}`}>
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a href="#services" className="rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2.5 sm:px-6 sm:py-3 font-semibold text-black shadow-[0_0_28px_rgba(20,244,212,0.35)] transition-all hover:scale-105 hover:shadow-[0_0_48px_rgba(124,58,237,0.55)] text-center text-sm sm:text-base">View Services</a>
              <Link href="/contact" className="rounded-xl border border-border/60 bg-secondary/50 px-4 py-2.5 sm:px-6 sm:py-3 font-semibold hover:bg-secondary/70 transition-colors text-center text-sm sm:text-base">Free Consultation</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section ref={gallery.ref} className="container py-12 sm:py-16 md:py-20 lg:py-28 bg-black">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 sm:gap-6">
          ...
          <Link href="/gallery" className="hidden sm:inline-flex rounded-xl px-4 py-2 sm:px-5 sm:py-2.5 bg-secondary/60 hover:bg-secondary/80 transition-colors text-sm sm:text-base">View all</Link>
        </div>
        ...
        <div className="mt-6 sm:mt-8 sm:hidden">
          <Link href="/gallery" className="inline-flex rounded-xl px-4 py-2 sm:px-5 sm:py-2.5 bg-secondary/60 hover:bg-secondary/80 transition-colors text-sm">View all</Link>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-gray-900">
        ...
        <div className="container relative py-12 sm:py-16">
          <div className="flex flex-col items-center text-center">
            ...
            <Link href="/contact" className="mt-4 sm:mt-6  bg-gradient-to-r from-primary to-accent px-4 py-2.5 sm:px-6 sm:py-3 text-black font-semibold shadow-[0_0_28px_rgba(20,244,212,0.35)] transition-all hover:scale-105 hover:shadow-[0_0_48px_rgba(124,58,237,0.55)] text-sm sm:text-base rounded-xl">
              Book Your Session
            </Link>
          </div>
        </div>
