      ...
      <section className="container grid min-h-[50svh] items-center gap-6 sm:gap-8 md:gap-10 py-8 sm:py-12 md:py-20 pt-20 sm:pt-24 md:pt-28">
        <div>
          ...
          <div className="mt-6 sm:mt-8 flex gap-4">
            <Link href="/contact" className="rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2 sm:px-5 sm:py-2.5 font-semibold text-black shadow-[0_0_24px_rgba(20,244,212,0.35)] transition-all hover:scale-105 text-sm sm:text-base">Start your design</Link>
          </div>
        </div>
      ...
      <section className="container py-12 sm:py-16 md:py-24 bg-gray-900">
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
          <ServiceCard
            ...
            icon={<Wand2 />}
            cta={<Link href="/contact" className="inline-flex rounded-xl bg-gradient-to-r from-primary to-accent px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-semibold text-black">Start Your Design</Link>}
          />
          <div className="group rounded-xl border border-border/60 bg-secondary/30 p-0 shadow-xl overflow-hidden md:col-span-2 lg:col-span-1">
            ...
            <div className="p-4 sm:p-6">
              ...
              <Link href="/contact" className="mt-3 sm:mt-4 inline-flex rounded-xl border border-border/60 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm hover:bg-secondary/60">Request evaluation</Link>
            </div>
          </div>
          <ServiceCard
            title="Consultations"
            ...
            icon={<PenTool />}
            cta={<Link href="/contact" className="inline-flex items-center gap-1 sm:gap-2 rounded-xl border border-border/60 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm hover:bg-secondary/60"><Calendar size={14} className="sm:w-4 sm:h-4"/>Book Free Consult</Link>}
          />
        </div>
      </section>
      ...
      <section className="container pb-12 sm:pb-16 md:pb-24 bg-black">
        <div className="rounded-2xl border border-border/60 bg-secondary/30 p-4 sm:p-6 md:p-10">
          ...
          <div className="mt-6 sm:mt-8">
            <Link href="/contact" className="inline-block rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2.5 sm:px-6 sm:py-3 font-semibold text-black shadow-[0_0_24px_rgba(20,244,212,0.35)] transition-all hover:scale-105 text-sm sm:text-base">Get a precise quote</Link>
          </div>
        </div>
      </section>
