              ...
              <CardContent className="p-4 sm:p-6">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6" noValidate>
                  ...
                  <Button 
                    type="submit" 
                    disabled={isSubmitting} 
                    className="w-full rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2.5 sm:py-3 text-black font-semibold shadow-[0_0_20px_rgba(20,244,212,0.35)] transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(124,58,237,0.55)] text-sm sm:text-base"
                    aria-live="polite"
                  >
