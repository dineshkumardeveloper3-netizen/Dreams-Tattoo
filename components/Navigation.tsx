      ...
      <div className="container">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:block">
            <Link 
              href="/contact"
              className="rounded-xl bg-gradient-to-r from-cyan-400 to-purple-600 px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm font-semibold text-black shadow-[0_0_28px_rgba(20,244,212,0.35)] transition-all hover:scale-105 hover:shadow-[0_0_48px_rgba(124,58,237,0.55)]"
            >
              Book Now
            </Link>
          </div>
